const setFeatureByPath = (path, value) => { let obj = window; const parts = path.split('.'); while (parts.length > 1) obj = obj[parts.shift()]; obj[parts[0]] = value; }Add commentMore actions
...
let featuresList = [
    ...
    { name: 'Accuracy', className: 'Accuracy', type: 'checkbox', variable: 'features.Accuracy', attributes: 'style="display:none;"', labeled: true, label: 'Accuracy (0% - 100%)' }, 
