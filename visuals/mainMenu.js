...
let featuresList = [
    ...
    { name: 'Accuracy', className: 'Accuracy', type: 'range', variable: 'features.autoAnswerDelay', attributes: 'style="display:none;" min="0" max="100" value="100"', labeled: true, label: 'Accuracy (0% - 100%)' },
