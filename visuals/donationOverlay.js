...
donateIframe.style.cssText = 'width:800px;height:400px;border:none;transform:scale(0.5);transform-origin:top left;background:transparent';
...
qrIframe.style.cssText = 'width:400px;height:600px;border:none;transform:scale(0.375);transform-origin:top right;background:transparent';
