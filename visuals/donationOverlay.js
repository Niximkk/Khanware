...
pixieContainer.style.cssText = 'position:fixed;top:10px;left:50%;transform:translateX(-50%);z-index:9999;width:min(400px,95vw);overflow:hidden';

const qrContainer = document.createElement('div');
qrContainer.style.cssText = 'position:fixed;bottom:20px;right:20px;z-index:9999;height:225px;overflow:hidden';
...
donateIframe.style.cssText = 'width:800px;height:400px;border:none;transform:scale(0.5);transform-origin:top left';
...
qrIframe.style.cssText = 'width:400px;height:600px;border:none;transform:scale(0.375);transform-origin:top right';
